# Generated migration for all model updates
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # --- StockItem new fields and defaults ---
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant', models.ForeignKey(
                    ...
                    to='sylistockapp.merchantprofile')),
                ...
                ('previous_verification', models.ForeignKey(
                    blank=True, null=True,
                    on_delete=django.db.models.deletion.SET_NULL,
                    to='sylistockapp.kycverification')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('premium_paid_date', models.DateTimeField(
                    blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('policy', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    related_name='claims',
                    to='sylistockapp.insurancepolicy')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_risk', models.IntegerField(
                    default=50,
                ...
                ('assessment_date', models.DateTimeField(
                    auto_now_add=True)),
                ('next_assessment_due', models.DateTimeField(
                    blank=True, null=True)),
