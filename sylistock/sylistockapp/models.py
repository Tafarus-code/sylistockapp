...
class MerchantProfile(models.Model):
    ...
    bankability_score = models.DecimalField(max_digits=5, decimal_places=2, default=0.0)
...
class StockItem(models.Model):
    ...
    cost_price = models.DecimalField(max_digits=12, decimal_places=2) # Purchase price
    sale_price = models.DecimalField(max_digits=12, decimal_places=2) # Tag price
...
class InventoryLog(models.Model):
    ...
    device_id = models.CharField(max_length=255, help_text="Serial or UUID")
